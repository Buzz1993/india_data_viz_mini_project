#some codes we write in the colab and then use here
...
if plot:
    ...
    if selected_state == 'Overall India':
        ...
        #size = primary--> according to size will see the primary parameter
        #color=secondary--> according to color will see the secondary parameter
        st.plotly_chart(fig,use_container_width=True)
        #use_container_width=True-->this align the graph in middle in HTML page
    else:
        #plot for state
